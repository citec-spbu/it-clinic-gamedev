...
## Автоматизация расстановки таймингов
 В проекте реализован удобный инструмент(скрипт) для автомитечской расстановки битов в музыкальном файле. Скрипт работает такбим образом, что из музыкального файла вычисляет моменты ритма и записывает в CSV файл. А после, скрипт расставляет триггеры по таймингам в музыкальной дорожке.
